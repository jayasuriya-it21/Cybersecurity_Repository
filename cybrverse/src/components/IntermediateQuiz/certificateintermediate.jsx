...
function Certificateintermediate() {
    ...
    <div className="certificate-page-container">
      <div className="course-details-container">
        <div className="course-details">
          ...
          <ul>
            <li><strong>Title:</strong> Cybersecurity Intermediate</li>
        ...
        <div className="certificate-preview" ref={certificateRef}>
          ...
          <h2>{userName}</h2>
          <p>has passed the Cybersecurity Intermediate and is hereby declared a</p>
...
export default Certificateintermediate;
